...
public class Forum {
    ...
    private static void forum(SLL<Discussion> health, SLL<Discussion> finance) {
        ...
        SLLNode<Discussion> tmp=null;
        int min=Integer.MAX_VALUE;
        while(dvizi!=null){
            if(dvizi.element.getUsers()*dvizi.element.getPopularity()<min){
                min=dvizi.element.getPopularity()*dvizi.element.getUsers();
                tmp=dvizi;
            }
            dvizi=dvizi.succ;
        }
        ...
        while(dvizi!=null){
            if(dvizi.element.getUsers()*dvizi.element.getPopularity()>max){
                max=dvizi.element.getPopularity()*dvizi.element.getUsers();
                tmp=dvizi;
            }
            dvizi=dvizi.succ;
        }

        finance.insertLast(tmp.element);
    }
